...
class RouteRoomController extends PrivilegeController
{
    public $excelObj;
    public $excelSheet;
    public $excelName;
    ...
    public function test()
    {
        ...
        $data['hotel_id'] = '1';
        $data['room_id'] = '1';
        $data['expired_year'] = '2017';
        $data['expired_month'] = '01';
        $data['expired_day'] = 11;
        $data['room_amount'] = 3;
        $roomModel->setUniqueIndex();
        $data = $roomModel->modify($data);
        halt($data);
        $roomModel->setUniqueIndex();
    }
    ...
    public function importExcel(Request $request)
    {
        ...
        $roomModel = new RoomModel();
        $roomModel->setUniqueIndex();
        $roomModel->replaceAll($data);
        return getSucc('文件上传成功');
    }

    public function exportExcel(Request $request,$roomId,$year)
    {
        ...
        $data['month_amount'] = $roomModel->where($where)->group('expired_month')->column('expired_month');
        $data['room_data'] = $ret;
